...
Установка самого OpenFlux на клиент или сервер, CLI-меню, обновления и восстановление cookies:
[руководство](integration/README.md). Windows-приложение и конкретная конфигурация роутера не требуются.
